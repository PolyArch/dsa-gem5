...
enum SDRegIdx {
   ...
   SD_NUM_STRIDES, SD_NUM_ELEM, SD_CFG_SIZE, SD_STRETCH, 
   SD_NUM_BYTES, SD_CONSTANT, SD_IN_PORT, SD_OUT_PORT,
   SD_IND_PORT, SD_IND_TYPE, SD_DTYPE, SD_OFFSET_LIST, SD_IND_MULT,
   SD_WAIT_MASK, SD_SHIFT_BYTES, SD_GARBAGE, SD_GARB_ELEM, 
...
const char* const SDRegNames[] = {
   ...
   "WAIT_MASK", "SHIFT_BYTES", "GARBAGE", "SD_GARB_ELEM", 
   "SD_NUM_ELEM2", "SD_CONSTANT2", "SD_FLAGS", "SD_CONTEXT", "SD_REPEAT", "SD_REPEAT_STRETCH",
   "NUM_REG"
  };
